...
public partial class WorkoutsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<WorkoutInfo>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__WorkoutI__3213E83FD2AA168D");

            entity.ToTable("WorkoutInfo");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.WorkoutInfos)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__WorkoutIn__user___59FA5E80");
        });
